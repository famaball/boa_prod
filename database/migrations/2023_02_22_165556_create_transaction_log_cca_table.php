...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaction_log_cca', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('transmis_au_partenaire')->nullable()->default(0);
            ...
            $table->boolean('by_api')->default(0)->nullable();
            $table->string('observations')->nullable();
            $table->double('commission_partenaire')->default(0)->nullable();
            $table->string('autre_numero_partenaire')->nullable();
            $table->dateTime('date_payout_update')->nullable();
            $table->dateTime('date_payout_confirm')->nullable();
            $table->string('code_reponse_pu')->nullable();
            $table->string('code_reponse_pc')->nullable();
            $table->string('pays_provenance_partenaire')->nullable();
            $table->string('devise_provenance_partenaire')->nullable();
            $table->double('montant_dev_partenaire')->default(0)->nullable();
            $table->double('comm_dev_partenaire')->default(0)->nullable();
            $table->double('taux_dev_partenaire')->default(0)->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('transaction_log_cca');
    }
};
